...
namespace com.largelabs.safetyquest
{
    public class SafetyQuestMusicCrossfade : MonoBehaviour
    {
        private static SafetyQuestMusicCrossfade instance = null;
        ...
        public static SafetyQuestMusicCrossfade Instance
        {
            get
            {
                if (null == instance)
                    instance = GameObject.FindObjectOfType<SafetyQuestMusicCrossfade>();

                if (null == instance)
                {
                    string name = null;
#if UNITY_EDITOR
                    name = "AudioSourceCrossfade";
#endif
                    GameObject go = new GameObject(name);
                    instance = go.AddComponent<SafetyQuestMusicCrossfade>();
                }
