...
public abstract class Platform : MonoBehaviourBase
{
    ...
    [SerializeField] private string compatibleTag = null;
    ...
    protected virtual void onDidHandleCollision(Collision2D i_other, PlatformCollisionData i_collisionParams)
    {
    ...
    {
        if (null == platformCollider) return;
